...
module.exports = class SingleAxisScroller
	...
	constructor: (@props, @askForAnimation, options = {}) ->
		...
		# Free space to wiggle in. @space
		# How big is the scrolling element (the child one). @size
		@_resetSizeAndSpace options.space, options.size
